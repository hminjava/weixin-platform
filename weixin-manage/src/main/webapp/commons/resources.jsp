...
<meta name="author" content="net.shangtech.songxh" />
<link rel="stylesheet" href="${staticServer}/manage/template/css/bootstrap.css" />
<link rel="stylesheet" href="${staticServer}/manage/template/css/bootstrap-responsive.css" />
...
<%--<script src="${staticServer}/manage/template/js/d3.v3.min.js"></script>--%>
<%--<script src="${staticServer}/manage/template/js/jquery.sparkline.min.js"></script>--%>
<%--<script src="${staticServer}/manage/template/js/toastr.js"></script>--%>
<%--<script src="${staticServer}/manage/template/js/jquery.tablesorter.min.js"></script>--%>
<%--<script src="${staticServer}/manage/template/js/jquery.peity.min.js"></script>--%>
...
<script type="text/javascript">var staticServer = '${staticServer}';</script>